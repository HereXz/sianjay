...
cd
mkdir /root/zoonk
wget -q -O /usr/bin/updatsc "https://raw.githubusercontent.com/HereXz/sianjay/main/update.sh"
wget -q -O /usr/bin/xp "https://raw.githubusercontent.com/HereXz/sianjay/main/xp.sh"
cd /root/zoonk
wget https://raw.githubusercontent.com/HereXz/sianjay/main/zonk.zip >/dev/null 2>&1
7z e -ptakbebehsangatganteng zonk.zip
rm -f zonk.zip
chmod +x *
mv * /usr/bin/
cd
